<div class="card">
  <div class="card-body">
    <a href="{{route('topics.create')}}" class="btn btn-success btn-block" aria-label="Left Align">
      <i class="fas fa-pencial-alt mr-2"></i>  新建帖子
    </a>
  </div>
</div>
      ...
      @foreach($active_users as $active_user)
        <a href="{{route('users.show',$active_user->id)}}" class="media mt-2">
          <div class="media-left media-middle mr-2 ml-1">
            <img src="{{$active_user->avatar}}" width="24" height="24" alt="{{$active_user->name}}" class="media-object">
          </div>
...
<div class="card mt-4">
  <div class="card-body pt-2">
    <div class="text-canter mt-1 mb-0 text-muted">资源推荐</div>
    <hr class="mt-2 mb-3">
